...
public class DialogUtils {
	...
	public static String chooseEnvironment() {
		...
		String s = Messages.showEditableChooseDialog("Environment:", "Run with Autotest Against Environment",
				Messages.getQuestionIcon(), choices, last, new NonEmptyInputValidator());
		if (s != null) {
